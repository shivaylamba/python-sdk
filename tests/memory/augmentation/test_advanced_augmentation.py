...
@pytest.mark.asyncio
async def test_process_api_response_already_memories_object(augmentation):
    memories = Memories()
    memories.entity.facts = ["Test fact"]

    result = await augmentation._process_api_response(memories)
